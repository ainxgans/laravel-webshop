...
<div class="min-w-screen mx-6 p-8 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 text-white">
<div class="flex flex-row">
    <div class="max-w-[50%]">
        <img src="{{ asset('storage/'. $product->thumbnail) }}" alt="" class="rounded-lg">
    </div>
    <div class="flex flex-col mx-6 w-full">
        <h2 class="text-4xl font-extrabold dark:text-white mb-6">{{ $product->name }}</h2>
        <p class="text-gray-500 dark:text-gray-400 flex-initial mb-10">{!! $product->description !!}</p>
        <div class="flex  mt-16">
            <a href="https://wa.me/6285156742122?text={{ $pesan }}" target="_blank" class="w-1/2 py-2 bg-emerald-400 text-center rounded-lg mx-4">Whatsapp</a>
